...
from patient_transport_report.application_service import ListBuzonApplicationService
from rest_framework.throttling import UserRateThrottle

class ListBuzonView(BaseView):
    '''
    ...
    def get(
        ...
        def service_callback(validated_data: dict | None = None) -> dict[str, Any]:
            ...
            '''
            list_buzon_service: ListBuzonApplicationService = ListBuzonApplicationService()
            return list_buzon_service.list_user_reports(user=request.user)
