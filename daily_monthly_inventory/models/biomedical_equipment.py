...
class BiomedicalEquipment(models.Model):
    monitor = models.IntegerField(
        default=0, validators=[MaxValueValidator(10)], help_text="Monitor quantity"
    )
    aed = models.IntegerField(
        default=0, validators=[MaxValueValidator(10)], help_text="AED quantity"
    )
    adult_pads = models.IntegerField(
        default=0, validators=[MaxValueValidator(10)], help_text="Adult pads quantity"
    )
    ...
    aspirator = models.IntegerField(
        default=0, validators=[MaxValueValidator(10)], help_text="Aspirator quantity"
    )
    flowmeter = models.IntegerField(
        default=0, validators=[MaxValueValidator(10)], help_text="Flowmeter quantity"
    )
    glucometer = models.IntegerField(
        default=0, validators=[MaxValueValidator(10)], help_text="Glucometer quantity"
    )
    ...
    search_light = models.IntegerField(
        default=0, validators=[MaxValueValidator(10)], help_text="Search light quantity"
    )
