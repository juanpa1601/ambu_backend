...
class Circulatory(models.Model):
    ...
    dextrose_5_percent = models.IntegerField(
        default=0, validators=[MaxValueValidator(10)], help_text="Dextrose 5% quantity"
    )
    dextrose_10_percent = models.IntegerField(
        default=0, validators=[MaxValueValidator(10)], help_text="Dextrose 10% quantity"
    )
    ...
    syringe_1cc = models.IntegerField(
        default=0, validators=[MaxValueValidator(20)], help_text="Syringe 1cc quantity"
    )
    syringe_3cc = models.IntegerField(
        default=0, validators=[MaxValueValidator(20)], help_text="Syringe 3cc quantity"
    )
    syringe_5cc = models.IntegerField(
        default=0, validators=[MaxValueValidator(20)], help_text="Syringe 5cc quantity"
    )
    syringe_10cc = models.IntegerField(
        default=0, validators=[MaxValueValidator(10)], help_text="Syringe 10cc quantity"
    )
    syringe_20cc = models.IntegerField(
        default=0, validators=[MaxValueValidator(10)], help_text="Syringe 20cc quantity"
    )
    syringe_50cc = models.IntegerField(
        default=0, validators=[MaxValueValidator(10)], help_text="Syringe 50cc quantity"
    )
