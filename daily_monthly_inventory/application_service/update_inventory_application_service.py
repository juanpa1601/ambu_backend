        ...
        try:
            ...
            if 'ambulance_id' in update_data:
                if update_data['ambulance_id'] is None:
                    ...
                    try:
                        ambulance = Ambulance.objects.get(pk=update_data['ambulance_id'])
            ...
            if 'surgical' in update_data:
                if inventory.surgical:
                    ...
                    inventory.surgical = Surgical.objects.create(**update_data['surgical'])
            ...
            if 'respiratory' in update_data:
                if inventory.respiratory:
                    ...
                    inventory.respiratory = Respiratory.objects.create(**update_data['respiratory'])
            ...
            if 'immobilization_and_safety' in update_data:
                if inventory.immobilization_and_safety:
                    ...
                    inventory.immobilization_and_safety = ImmobilizationAndSafety.objects.create(
            ...
            if 'accessories' in update_data:
                if inventory.accessories:
                    ...
                    inventory.accessories = Accessories.objects.create(**update_data['accessories'])
            ...
            if 'additionals' in update_data:
                if inventory.additionals:
                    ...
                    inventory.additionals = Additionals.objects.create(**update_data['additionals'])
            ...
            if 'pediatric' in update_data:
                if inventory.pediatric:
                    ...
                    inventory.pediatric = Pediatric.objects.create(**update_data['pediatric'])
            ...
            if 'circulatory' in update_data:
                if inventory.circulatory:
                    ...
                    inventory.circulatory = Circulatory.objects.create(**update_data['circulatory'])
            ...
            if 'ambulance_kit' in update_data:
                if inventory.ambulance_kit:
                    ...
                    inventory.ambulance_kit = AmbulanceKit.objects.create(**update_data['ambulance_kit'])
