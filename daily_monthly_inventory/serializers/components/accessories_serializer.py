...
class AccessoriesSerializer(serializers.Serializer):
    ...
    wypall_towels = serializers.IntegerField(
        required=False, min_value=0, max_value=20, help_text="Wypall towels quantity"
    )
    patient_blanket = serializers.IntegerField(
        required=False, min_value=0, max_value=10, help_text="Patient blanket quantity"
    )
    stretcher_sheet = serializers.IntegerField(
        required=False, min_value=0, max_value=20, help_text="Stretcher sheet quantity"
    )
    gloves_boxes = serializers.IntegerField(
        required=False, min_value=0, max_value=10, help_text="Gloves boxes quantity"
    )
    ...
    white_waste_bags = serializers.IntegerField(
        required=False, min_value=0, max_value=20, help_text="White waste bags quantity"
    )
    ...
    clean_gauze_pack = serializers.IntegerField(
        required=False, min_value=0, max_value=10, help_text="Clean gauze pack quantity"
    )
    ...
    wheelchair = serializers.IntegerField(
        required=False, min_value=0, max_value=10, help_text="Wheelchair quantity"
    )
    ...
    male_urinal = serializers.IntegerField(
        required=False, min_value=0, max_value=10, help_text="Male urinal quantity"
    )
    female_urinal = serializers.IntegerField(
        required=False, min_value=0, max_value=10, help_text="Female urinal quantity"
    )
