...
class AdditionalsSerializer(serializers.Serializer):
    ...
    tablet = serializers.IntegerField(
        required=False, min_value=0, max_value=10, help_text="Tablet quantity"
    )
    charger = serializers.IntegerField(
        required=False, min_value=0, max_value=10, help_text="Charger quantity"
    )
    ...
    artificial_tears = serializers.IntegerField(
        required=False, min_value=0, max_value=10, help_text="Artificial tears quantity"
    )
